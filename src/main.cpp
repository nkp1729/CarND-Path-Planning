...
int main() {
  ...
  bool lane_change_finished = true;
  int previous_lane = 1;

  h.onMessage([ &lane, &ref_vel, &in_lane_change, &lane_change_finished, &previous_lane,
    ...
    if (length && length > 2 && data[0] == '4' && data[1] == '2') {
      ...
      if (s != "") {
        ...
        if (event == "telemetry") {
          ...
          if (in_lane_change and current_lane == lane){
           ...
           */
           ...
           // start with all the previous points left over since last time
           ...
           // fill in the rest of the path with the spline
